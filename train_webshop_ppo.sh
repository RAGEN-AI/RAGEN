...
#     trainer.default_local_dir=/mnt/local/ragen_checkpoints/webshop_starpos_ppo_3b_0508 \
#     trainer.nnodes=1
...
#     trainer.default_local_dir=/mnt/local/ragen_checkpoints/webshop_starpo_ppo_3b_0508 \
#     trainer.nnodes=1
...
#     trainer.experiment_name=webshop_starpo_ppo_0.5b $USE_PPO $USE_BASE \
#     es_manager.train.env_groups=2 es_manager.train.group_size=16 es_manager.train.env_configs.n_groups=[2] \
#     es_manager.val.env_groups=128 es_manager.val.group_size=1 es_manager.val.env_configs.n_groups=[128] \
#     system.CUDA_VISIBLE_DEVICES=\"0,1,2,3\" trainer.n_gpus_per_node=4 actor_rollout_ref.rollout.tensor_model_parallel_size=2 actor_rollout_ref.rollout.tp_size_check=False \
#     trainer.default_local_dir=/mnt/local/ragen_checkpoints/webshop_starpo_ppo_0.5b_0508 \
#     trainer.nnodes=1

# MKL_SERVICE_FORCE_INTEL=1 python train.py --config-name _6_webshop \
#     $USE_BASE $USE_GRPO \
#     model_path=Qwen/Qwen2.5-3B-Instruct \
#     trainer.experiment_name=webshop_starpo_grpo_3b_full \
#     es_manager.train.env_groups=2 es_manager.train.group_size=16 es_manager.train.env_configs.n_groups=[2] \
#     es_manager.val.env_groups=64 es_manager.val.group_size=1 es_manager.val.env_configs.n_groups=[64] \
#     system.CUDA_VISIBLE_DEVICES=\"0,1,2,3\" trainer.n_gpus_per_node=4 actor_rollout_ref.rollout.tensor_model_parallel_size=4 \
#     trainer.default_local_dir=/mnt/local/ragen_checkpoints/webshop_starpo_grpo_3b_full_0508 \
#     trainer.nnodes=1
